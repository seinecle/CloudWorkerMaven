...
//    Timer timer;
//    ActorRef parent;
//    Map<Integer, Set<Integer>> userAndItsFriends;
//
...
//
//        if (message instanceof MsgSetTwitterIdsAndMongo) {
//            MsgSetTwitterIdsAndMongo msgReceived = (MsgSetTwitterIdsAndMongo) message;
//            this.setIdsInitialSeed = msgReceived.getSetIdsSeed();
//            this.mm = msgReceived.mm;
...
//
//        System.out.println("in the call method of GetFriends");
//        userAndItsFriends = new HashMap();
//        for (Iterator<Integer> it = setIdsInitialSeed.iterator(); it.hasNext();) {
//            int id = it.next();
//            boolean done = false;
//            while (!done) {
//                try {
...
//                }
//            }
//            userAndItsFriends.put(id, setFriends);
//        }
//        timer.close();
//        MsgMapTwitterIds msgSetFriends = new MsgMapTwitterIds(userAndItsFriends);
//        parent.tell(msgSetFriends, getSelf());
//    }
//
//}

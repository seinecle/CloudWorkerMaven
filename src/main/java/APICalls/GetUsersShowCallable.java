...
//
// */
//public class GetUsersShowCallable implements Callable{
//
//    Set<Integer> setIds;
...
//
//    public GetUsersShowCallable(Set<Integer> setIds, MongoMorphia mm) {
//        this.setIds = setIds;
//        totalCalls = setIds.size();
//        this.mm = mm;
//    }
//
//    public GetUsersShowCallable(List<String> listScreenNames, MongoMorphia mm) {
...
//
//    @Override
//    public Set<User> call() throws UnknownHostException, InterruptedException {
//
//        users = new HashSet();
//
